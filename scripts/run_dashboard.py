...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--log-file", default="logs/demo_rebalance_runner_72h.jsonl")
    parser.add_argument("--summary-file", default="reports/demo_rebalance_runner_72h.json")
